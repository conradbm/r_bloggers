...
# In conclusion, we would select the first alternative, because he has the highest CScore; closest to the best attributes and         farthest from the worst attributes.

# A condensed, more portable version of this algorithm is given in the following function:

```{r}
### Parameters: data.frame object
###
### Standard Decision Matrix Shape (N+1)xD:
###
...
## More functions to be considered into the `library(madm)` package will include `Saw`, `ELECTRE`, `PREMETHEE`, and a few other non-compensatory methods along with easy scalability for sensitivity analysis. 
