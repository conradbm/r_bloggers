...
## More functions to be considered into the `library(madm)` package will include `SAW`, `ELECTRE`, `PREMETHEE`, and a few other non-compensatory methods along with easy scalability for sensitivity 
